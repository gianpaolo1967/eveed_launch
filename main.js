document.getElementById('btn').onclick = function() {
	...
	var arr = str.split(' ');
		...
		p0.innerHTML += '18' + os.charAt(0).toLowerCase() + sex.charAt(0).toLowerCase();
		p1.innerHTML += '24' + os.charAt(0).toLowerCase() + sex.charAt(0).toLowerCase();
		p2.innerHTML += '30' + os.charAt(0).toLowerCase() + sex.charAt(0).toLowerCase();
